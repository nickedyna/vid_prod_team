# Production Notes — roadmap-2026_01

- Brand: Nat O’Farril / AI Email Dev
- Slogan: Learn AI. Build proof. Grow your value.
- Production mode: **faceless** (no talking-head asset found; faceless first)
- Visual style: brief_to_zip_flow_map (fallback: enterprise_grid_pulse)
...
- `assets/broll/workflow_montage_fast.mp4` — placeholder. Record or export this clip.
- `assets/broll/folder_chaos_scroll.mp4` — placeholder. Record or export this clip.
...
- `assets/broll/roadmap_skill_stack.mp4` — placeholder. Record or export this clip.
- `assets/broll/corporate_desk_setup.mp4` — placeholder. Film or record a clean desk setup with monitor showing email/campaign work.
- `assets/broll/github_copilot_editing.mp4` — placeholder. Record or export this clip.
...
- `assets/broll/subscribe_end_card.mp4` — placeholder. Branded end card with subscribe button animation (make in CapCut/Canva).
- `assets/voiceover/roadmap-2026_01_voiceover.wav` — missing. Record the short script as a WAV (quiet room, phone or USB mic is fine).
